...
// Обычный Safari на iPhone рисует нижнюю панель поверх страницы.
// Отдельный класс резервирует под неё место, не затрагивая Telegram, PWA и iPad.
(function markIPhoneSafariBrowser() {
  ...
  if (isIPhone && isWebKit && !isOtherIOSBrowser && !isTelegram && !isStandalone) {
